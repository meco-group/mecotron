...
/* SAMPLE TIME */
#define TSAMPLE                             0.010  // sampling time in seconds
...
#define PEN_TO_RAD            2.0 * M_PI / 1023.0  // 10bit ADC signal to radians
...
class MECOtron : public HALBase {
  protected:
    ...
    Sensor1D* _speedA = new DifferenceSensor(_encoderA);
    Sensor1D* _speedB = new DifferenceSensor(_encoderB);
